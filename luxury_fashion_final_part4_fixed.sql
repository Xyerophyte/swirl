...
(gen_random_uuid(), 'BV-CASSETTE-181', 'other', 'https://www.bottegaveneta.com/cassette',
...
(gen_random_uuid(), 'BV-JODIE-182', 'other', 'https://www.bottegaveneta.com/jodie',
...
(gen_random_uuid(), 'BV-ARCO-183', 'other', 'https://www.bottegaveneta.com/arco',
...
(gen_random_uuid(), 'BV-POUCH-184', 'other', 'https://www.bottegaveneta.com/pouch',
...
(gen_random_uuid(), 'BV-BOOT-185', 'other', 'https://www.bottegaveneta.com/boots',
...
(gen_random_uuid(), 'BV-TIRE-186', 'other', 'https://www.bottegaveneta.com/tire',
...
(gen_random_uuid(), 'BV-SLIDER-187', 'other', 'https://www.bottegaveneta.com/slides',
...
(gen_random_uuid(), 'BV-COAT-188', 'other', 'https://www.bottegaveneta.com/coat',
...
(gen_random_uuid(), 'BV-SHIRT-189', 'other', 'https://www.bottegaveneta.com/shirt',
...
(gen_random_uuid(), 'BV-PANTS-190', 'other', 'https://www.bottegaveneta.com/pants',
...
(gen_random_uuid(), 'BV-KNIT-191', 'other', 'https://www.bottegaveneta.com/knitwear',
...
(gen_random_uuid(), 'BV-DRESS-192', 'other', 'https://www.bottegaveneta.com/dress',
...
(gen_random_uuid(), 'BV-WALLET-193', 'other', 'https://www.bottegaveneta.com/wallet',
...
(gen_random_uuid(), 'BV-BELT-194', 'other', 'https://www.bottegaveneta.com/belt',
...
(gen_random_uuid(), 'BV-SUNGLASSES-195', 'other', 'https://www.bottegaveneta.com/sunglasses',
...
(gen_random_uuid(), 'BV-BACKPACK-196', 'other', 'https://www.bottegaveneta.com/backpack',
...
(gen_random_uuid(), 'BV-LOAFER-197', 'other', 'https://www.bottegaveneta.com/loafers',
...
(gen_random_uuid(), 'BV-JACKET-198', 'other', 'https://www.bottegaveneta.com/jacket',
...
(gen_random_uuid(), 'BV-SCARF-199', 'other', 'https://www.bottegaveneta.com/scarf',
...
(gen_random_uuid(), 'BV-CARDHOLD-200', 'other', 'https://www.bottegaveneta.com/cardholder',
...
(gen_random_uuid(), 'BAL-CITY-201', 'other', 'https://www.balenciaga.com/city',
...
(gen_random_uuid(), 'BAL-HOURGLASS-202', 'other', 'https://www.balenciaga.com/hourglass',
...
(gen_random_uuid(), 'BAL-TRIPLE-203', 'other', 'https://www.balenciaga.com/triple-s',
...
(gen_random_uuid(), 'BAL-TRACK-204', 'other', 'https://www.balenciaga.com/track',
...
(gen_random_uuid(), 'BAL-SPEED-205', 'other', 'https://www.balenciaga.com/speed',
...
(gen_random_uuid(), 'BAL-HOODIE-206', 'other', 'https://www.balenciaga.com/hoodie',
...
(gen_random_uuid(), 'BAL-TSHIRT-207', 'other', 'https://www.balenciaga.com/tshirt',
...
(gen_random_uuid(), 'BAL-JACKET-208', 'other', 'https://www.balenciaga.com/jacket',
...
(gen_random_uuid(), 'BAL-BACKPACK-209', 'other', 'https://www.balenciaga.com/backpack',
...
(gen_random_uuid(), 'BAL-CAP-210', 'other', 'https://www.balenciaga.com/cap',
...
(gen_random_uuid(), 'BAL-PANTS-211', 'other', 'https://www.balenciaga.com/pants',
...
(gen_random_uuid(), 'BAL-COAT-212', 'other', 'https://www.balenciaga.com/coat',
...
(gen_random_uuid(), 'BAL-BELT-213', 'other', 'https://www.balenciaga.com/belt',
...
(gen_random_uuid(), 'BAL-SUNGLASSES-214', 'other', 'https://www.balenciaga.com/sunglasses',
...
(gen_random_uuid(), 'BAL-DRESS-215', 'other', 'https://www.balenciaga.com/dress',
...
(gen_random_uuid(), 'BAL-WALLET-216', 'other', 'https://www.balenciaga.com/wallet',
...
(gen_random_uuid(), 'BAL-SWEATER-217', 'other', 'https://www.balenciaga.com/sweater',
...
(gen_random_uuid(), 'BAL-SCARF-218', 'other', 'https://www.balenciaga.com/scarf',
...
(gen_random_uuid(), 'BAL-BOOT-219', 'other', 'https://www.balenciaga.com/boots',
...
(gen_random_uuid(), 'BAL-TOTE-220', 'other', 'https://www.balenciaga.com/tote',
